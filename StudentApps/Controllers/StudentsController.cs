...
namespace StudentApps
{
    public class StudentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("StudentNo,FirstName,LastName,BirthDay,Email,Phonenumber")] Student student)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("StudentNo,FirstName,LastName,BirthDay,Email,Phonenumber")] Student student)
        {
